...
urlpatterns = [
    ...
    path(
        'login/', 
        auth_views.LoginView.as_view(template_name='account/registration/login.html', redirect_authenticated_user=True, form_class=AccountLoginForm), 
        name='login'),
    ...
    path('profile/delete-confirm/', TemplateView.as_view(template_name='account/user/delete_confirm.html'), name='delete_confirm'),
